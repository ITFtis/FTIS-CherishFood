<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Highlights.aspx.cs" Inherits="Highlights" %>
        ...
        <div class="wrapper">
            ...
            <ul class="news-list j-d-flex j-flex-wrap">
                <asp:ListView ID="ListViewNews" runat="server">
                    <ItemTemplate>
                        <li>
                            <a href='HighlightsContents.aspx?Id=<%# Eval("Id") %>'>
                                <div class="photo">
