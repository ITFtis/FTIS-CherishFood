                ...
                <div>
                    <div class="k-apply-search">
                        <ul class="k-form-list">
                            <li>
                                <label class="k-form-label" for="txtAccount">會員密碼</label>
                                <asp:TextBox ID="txtNewPwd" runat="server" CssClass="k-form-input" placeholder="輸入密碼（限8~12碼且混合數字與大小寫英文）" required TextMode="Password"></asp:TextBox>
                            </li>
                            <li>
                                <label class="k-form-label" for="txtAccount">確認密碼</label>
                                <asp:TextBox ID="txtConfirmPwd" runat="server" CssClass="k-form-input" placeholder="請再次輸入密碼" required TextMode="Password"></asp:TextBox>
                            </li>
                        </ul>
