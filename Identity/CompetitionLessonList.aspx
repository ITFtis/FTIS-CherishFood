<%@ Page Title="" Language="C#" MasterPageFile="~/Identity/MasterPage.master" AutoEventWireup="true" CodeFile="CompetitionLessonList.aspx.cs" Inherits="Identity_CompetitionLessonList" %>
                ...
                <div class="col-xs-12">
                    ...
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title " style="float: right">
                                <asp:Button ID="btnGoadd" runat="server" Text="下載教案表" CssClass="btn btn-success" CommandName="DownloadWorkFile" OnCommand="btn_OnCommand" CausesValidation="false" />
                                ...
                                <%--<asp:Button ID="Button5" runat="server" Text="下載相關教學檔案" CssClass="btn btn-success" CommandName="DownloadTeachingFile" OnCommand="btn_OnCommand" CausesValidation="false" />--%>
                            ...
                            <asp:ListView ID="ListView1" runat="server">
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <%--<td><%# GetFile(Eval("TeachingFile"))%></td>--%>
