<%@ Page Title="" Language="C#" MasterPageFile="~/Identity/MasterPage.master" AutoEventWireup="true" CodeFile="EmployeeEdit.aspx.cs" Inherits="Admin_EmployeeEdit" %>
                                    ...
                                    <div class="form-horizontal">
                                        <div class="box-body">
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    <asp:Label ID="Label1" AssociatedControlID="txtEmail" Text="信箱" CssClass="col-sm-2 control-label" runat="server" />
                                                    <div class="col-sm-10">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <asp:Label ID="Label3" AssociatedControlID="txtCountry" Text="單位" CssClass="col-sm-2 control-label" runat="server" />
                                                    <div class="col-sm-10">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <asp:TextBox ID="txtOwnerTel" CssClass="form-control" runat="server"></asp:TextBox>
                                                ...
                                                <div class="form-group">
                                                    <asp:Label ID="Label2" AssociatedControlID="ddlCounty" Text="所屬行政區" CssClass="col-sm-2 control-label" runat="server" />
                                                    <div class="col-sm-10">
                                            ...
                                            <div class="form-group  col-sm-12">
                                                <div class="panel panel-primary">
                                                    ...
                                                    <div class="panel-body">
                                                        <asp:FileUpload ID="FileUpload1" data-dir="Employee" CssClass="Sinputfiles" data-ext="jpg,jpeg,png,gif,svg,tiff" accept=".jpg, .jpeg, .png, .gif, .svg, .tiff" runat="server" />
