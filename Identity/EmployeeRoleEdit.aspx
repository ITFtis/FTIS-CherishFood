<%@ Page Title="" Language="C#" MasterPageFile="~/Identity/MasterPage.master" AutoEventWireup="true" CodeFile="EmployeeRoleEdit.aspx.cs" Inherits="Admin_EmployeeRoleEdit" %>
                                        ...
                                        <div class="box-body">
                                            <div class="form-group  col-sm-12">
                                                    <asp:ListView ID="ListView2" runat="server">
                                                        <ItemTemplate>
                                                            <tr>
                                                                <td><span  class='<%# Eval("ParentId").ToString()=="0"?"text-danger":"" %>'><%# Eval("Name") %></span></td>

                                                                <td>
                                                                    <asp:HiddenField ID="HidPermissionpId" runat="server" Value='<%# Eval("EmployeePermissionId") %>' />
                                                                    <asp:CheckBox ID="IsCharge" runat="server" />
                                                                </td>
                                                            </tr>
                                                        </ItemTemplate>
