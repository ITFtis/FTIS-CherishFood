<%@ Page Title="" Language="C#" MasterPageFile="~/Identity/MasterPage.master" AutoEventWireup="true" CodeFile="FinalCompetitionLessonEdit.aspx.cs" Inherits="Identity_FinalCompetitionLessonEdit" %>
                                    ...
                                    <div class="box-body">
                                        ...
                                        <asp:ListView ID="ListView1" runat="server" OnItemDataBound="ListView1_ItemDataBound">
                                            <ItemTemplate>
                                                <div class="box box-info box-solid">
                                                    <div class="box-header with-border">
                                                        <h3 class="box-title"><%# Eval("MemberTitle") %></h3>
                                                        <!-- /.box-tools -->
                                                    </div>
                                                    <!-- /.box-header -->
                                                    <div class="box-body">
                                                        <div class="col-lg-6 ">
                                                            <div class="form-group  ">
                                                                ...
                                                                <asp:TextBox ID="txtName" runat="server" CssClass="form-control" AutoComplete="OFF" Enabled="false" Text='<%# Eval("Name") %>'></asp:TextBox>
                                                                <div class="help-block with-errors"></div>
                                                            </div>
                                                            <div class="form-group  ">
                                                                <asp:Label ID="Label6" AssociatedControlID="txtBirthday" Text="生日" runat="server" />
                                                                <asp:TextBox ID="txtBirthday" runat="server" CssClass="form-control" AutoComplete="OFF" Enabled="false" Text='<%# Eval("Birthday","{0:yyyy-MM-dd}") %>'></asp:TextBox>
                                                                <div class="help-block with-errors"></div>
                                                            </div>
                                                            <div class="form-group  ">
                                                                <asp:Label ID="Label7" AssociatedControlID="txtMail" Text="聯絡信箱" runat="server" />
                                                                <asp:TextBox ID="txtMail" runat="server" CssClass="form-control" AutoComplete="OFF" Enabled="false" Text='<%# Eval("Mail") %>'></asp:TextBox>
                                                                <div class="help-block with-errors"></div>
                                                            </div>
                                                            <div class="form-group  ">
                                                                <asp:Label ID="Label8" AssociatedControlID="txtJobTitle" Text="職稱/年級" runat="server" />
                                                                <asp:TextBox ID="txtJobTitle" runat="server" CssClass="form-control" AutoComplete="OFF" Enabled="false" Text='<%# Eval("JobTitle") %>'></asp:TextBox>
                                                                <div class="help-block with-errors"></div>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6 ">
                                                            <div class="form-group  ">
                                                                ...
                                                                <asp:TextBox ID="txtIdentityNo" runat="server" CssClass="form-control" AutoComplete="OFF" Enabled="false" Text='<%# Eval("IdentityNo") %>'></asp:TextBox>
                                                                <div class="help-block with-errors"></div>
                                                            </div>
                                                            <div class="form-group  ">
                                                                <asp:Label ID="Label9" AssociatedControlID="txtPhone" Text="姓名" runat="server" />
                                                                <asp:TextBox ID="txtPhone" runat="server" CssClass="form-control" AutoComplete="OFF" Enabled="false" Text='<%# Eval("Phone") %>'></asp:TextBox>
                                                                <div class="help-block with-errors"></div>
                                                            </div>
                                                            <div class="form-group  ">
                                                                <asp:Label ID="Label10" AssociatedControlID="txtName" Text="服務單位/學校" runat="server" />
                                                                <asp:TextBox ID="txtUnitName" runat="server" CssClass="form-control" AutoComplete="OFF" Enabled="false" Text='<%# Eval("UnitName") %>'></asp:TextBox>
                                                                <div class="help-block with-errors"></div>
                                                            </div>
                                                            <asp:PlaceHolder ID="PlaceHolder1" runat="server" Visible='<%# (string)Eval("MemberTitle") == "隊長資料" %>'>
                                                                <div class="form-group  ">
                                                                    <asp:Label ID="Label15" AssociatedControlID="listSignArea" Text="報名區域" runat="server" />
                                                                    <asp:HiddenField ID="hidSignArea" runat="server" Value='<%# Eval("SignArea") %>' />
                                        ...
                                        <div class="col-lg-12 ">
                                            ...
                                            <div class="form-group ">
                                                <div class="panel panel-primary">
                                                    <div class="panel-heading">決賽教案表</div>
                                                    <div class="panel-body">
                                                        <asp:FileUpload ID="FileUpload2" data-dir="fpmWorkFile" data-ext="pdf" CssClass="Sinputfiles" runat="server" accept=".pdf" />
                                            ...
                                            <div class="form-group ">
                                                <div class="panel panel-primary">
                                                    ...
                                                    <div class="panel-body">
                                                        <asp:FileUpload ID="FileUpload1" data-dir="fpmAuthorizeFile" data-ext="pdf" CssClass="Sinputfiles" runat="server" accept=".pdf" />
                                            ...
                                            <div class="form-group ">
                                                <div class="panel panel-primary">
                                                    ...
                                                    <div class="panel-body">
                                                        <asp:FileUpload ID="FileUpload3" data-dir="fpmIntroduceFile" data-ext="pdf,ppt" CssClass="Sinputfiles" runat="server" accept=".pdf, .ppt" />
                                            ...
                                            <div class="form-group ">
                                                <div class="panel panel-primary">
                                                    ...
                                                    <div class="panel-body">
                                                        <asp:FileUpload ID="FileUpload4" data-dir="fpmRepresentativeConsent" data-ext="pdf" CssClass="Sinputfiles" runat="server" accept=".pdf" />
                                            ...
                                            <div class="form-group ">
                                                <div class="panel panel-primary">
                                                    <div class="panel-heading">相關教學檔案或照片</div>
                                                    <div class="panel-body">
                                                        <asp:FileUpload ID="FileUpload5" data-dir="fpmTeachingFile" data-ext="pdf,ppt,jpg,png,jpeg,zip,rar" CssClass="Sinputfiles" runat="server" accept=".pdf, .ppt, .jpg, .png, .jpeg, .zip, .rar" />
                                                        <asp:TextBox ID="txtTeachingFile" CssClass="form-control" runat="server"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group ">
                                                <div class="panel panel-primary">
                                                    <div class="panel-heading">決賽教學影片</div>
                                                    <div class="panel-body">
                                                        <asp:FileUpload ID="FileUpload6" data-dir="fpmTeachingVideoFile" data-ext="mp4,mov,wmv,mkv,avi,ts,zip,rar" CssClass="Sinputfiles" runat="server" accept=".mp4, .mov, .wmv, .mkv, .avi, .ts .zip, .rar" />
                                                        <asp:TextBox ID="txtTeachingVideoFile" CssClass="form-control" runat="server"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
