...
public partial class Identity_HighlightsEdit : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Id == 0) return;
        var result = _db.Highlights.FirstOrDefault(x => x.Id == Id);
    ...
    protected void btn_OnCommand(object sender, CommandEventArgs e)
    {
        ...
        switch (e.CommandName)
        {
            case "Save":
                if (Id != 0)
                {
                    var newRow = _db.Highlights.FirstOrDefault(x => x.Id == Id);
                    if (newRow != null)
                    {
                ...
                else
                {
                    ...
                    _db.Highlights.InsertOnSubmit(newRow);
                    _db.SubmitChanges();
