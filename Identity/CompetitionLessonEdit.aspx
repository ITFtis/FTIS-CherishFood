<%@ Page Title="" Language="C#" MasterPageFile="~/Identity/MasterPage.master" AutoEventWireup="true" CodeFile="CompetitionLessonEdit.aspx.cs" Inherits="Identity_CompetitionLessonEdit" %>
                                ...
                                <div class="box box-info box-solid">
                                    ...
                                    <div class="box-body">
                                        <div class="col-lg-12 ">
                                            ...
                                            <div class="form-group  ">
                                                <asp:Label ID="Label12" AssociatedControlID="litWorkFile" Text="教案表" runat="server" />
                                            ...
                                            <asp:PlaceHolder ID="PlaceHolder2" runat="server" Visible="false">
                                                <div class="form-group  ">
                                                    <asp:Label ID="Label15" AssociatedControlID="litTeachingFile" Text="相關教學檔案" runat="server" />
