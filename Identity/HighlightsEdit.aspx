<%@ Page Title="" Language="C#" MasterPageFile="~/Identity/MasterPage.master" AutoEventWireup="true" CodeFile="HighlightsEdit.aspx.cs" Inherits="Identity_HighlightsEdit" ValidateRequest="false" %>
                                            ...
                                            <div class="form-group ">
                                                <div class="panel panel-primary">
                                                    ...
                                                    <div class="panel-body">
                                                        <asp:FileUpload ID="FileUpload1" data-dir="Highlights" data-ext="jpg,jpeg,png,gif,svg,tiff" CssClass="Sinputfiles" runat="server" accept=".jpg, .jpeg, .png, .gif, .svg, .tiff"/>
